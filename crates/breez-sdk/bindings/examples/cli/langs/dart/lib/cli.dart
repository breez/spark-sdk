...
Future<void> runCli({
  ...
  if (stableBalanceTokenIdentifier != null) {
    config = config.copyWith(
      stableBalanceConfig: StableBalanceConfig(
        ...
        thresholdSats: stableBalanceThreshold != null ? BigInt.from(stableBalanceThreshold) : null,
        maxSlippageBps: null,
        reservedSats: null,
      ),
    );
  ...
  if (postgresConnectionString != null) {
    // PostgreSQL storage is not yet available in the Flutter/Dart bindings.
    // The withPostgresStorage method is not exposed via flutter_rust_bridge.
    print('Warning: --postgres-connection-string is not yet supported in the Dart CLI');
  }
...
Future<void> _runRepl(
  ...
  final allCommands = [...commandNames, ...issuerCommandNames, ...contactsCommandNames, 'exit', 'quit', 'help'];
