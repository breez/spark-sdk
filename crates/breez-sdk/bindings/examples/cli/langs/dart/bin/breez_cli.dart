...
Future<void> main(List<String> arguments) async {
  final parser =
      ArgParser()
        ...
        ..addOption('postgres-connection-string', help: 'PostgreSQL connection string (not yet supported)')
  ...
  final stableBalanceThreshold = stableBalanceThresholdStr != null ? int.parse(stableBalanceThresholdStr) : null;
