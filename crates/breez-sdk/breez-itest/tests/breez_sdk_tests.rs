...
/// Test 5: Send payment from Alice to Bob using Spark invoice
#[rstest]
#[test_log::test(tokio::test)]
async fn test_05_spark_invoice(
    #[future] alice_sdk: Result<SdkInstance>,
    #[future] bob_sdk: Result<SdkInstance>,
) -> Result<()> {
    info!("=== Starting test_05_spark_invoice ===");
    ...
    info!("=== Test test_05_spark_invoice PASSED ===");
    Ok(())
}
