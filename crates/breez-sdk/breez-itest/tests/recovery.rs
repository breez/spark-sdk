...
async fn test_setup_recovery_wallet() -> Result<()> {
    ...
    let prepare = bob
        .sdk
        .prepare_send_payment(PrepareSendPaymentRequest {
            payment_request: PaymentRequest::Input(alice_spark_address.clone()),
            amount: Some(3_000),
            token_identifier: None,
            conversion_options: None,
            fee_policy: None,
    ...
    let prepare = alice
        .sdk
        .prepare_send_payment(PrepareSendPaymentRequest {
            payment_request: PaymentRequest::Input(bob_invoice),
            amount: None,
            token_identifier: None,
            conversion_options: None,
            fee_policy: None,
    ...
    let prepare = bob
        .sdk
        .prepare_send_payment(PrepareSendPaymentRequest {
            payment_request: PaymentRequest::Input(alice_invoice),
            amount: None,
            token_identifier: None,
            conversion_options: None,
            fee_policy: None,
    ...
    let prepare = alice
        .sdk
        .prepare_send_payment(PrepareSendPaymentRequest {
            payment_request: PaymentRequest::Input(withdraw_address),
            amount: Some(10_000),
            token_identifier: None,
            conversion_options: None,
            fee_policy: None,
