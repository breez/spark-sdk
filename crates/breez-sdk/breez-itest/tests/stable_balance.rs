...
async fn test_stable_balance_reserved_sats(
    ...
    /*
        ...
        let conversion_payment_amount: u64 = 2_000;
        let direct_payment_amount: u64 = 500;
        ...
        let prepare_conv_1 = alice
            ...
            .prepare_send_payment(PrepareSendPaymentRequest {
                payment_request: bob_spark_address.clone(),
                pay_amount: Some(PayAmount::Bitcoin {
                    amount_sats: conversion_payment_amount,
                }),
                conversion_options: None,
            })
            .await?;
        ...
        let prepare_direct = alice
            ...
            .prepare_send_payment(PrepareSendPaymentRequest {
                ...
                pay_amount: Some(PayAmount::Bitcoin {
                    amount_sats: direct_payment_amount,
                }),
                conversion_options: None,
            })
            .await?;
