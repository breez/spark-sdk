...
async fn test_select_token_outputs() {
    let store = create_test_token_store("mysql_token_select_outputs").await;
    breez_sdk_spark::token_store_tests::test_select_token_outputs(&store).await;
}

#[wasm_bindgen_test]
async fn test_reserve_token_outputs_by_outpoints() {
    let store = create_test_token_store("mysql_token_reserve_by_outpoints").await;
    breez_sdk_spark::token_store_tests::test_reserve_token_outputs_by_outpoints(&store).await;
}

#[wasm_bindgen_test]
async fn test_reserve_token_outputs() {
    let store = create_test_token_store("mysql_token_reserve_outputs").await;
    breez_sdk_spark::token_store_tests::test_reserve_token_outputs(&store).await;
}

#[wasm_bindgen_test]
async fn test_reserve_with_preferred_outputs() {
    let store = create_test_token_store("mysql_token_reserve_preferred").await;
...
async fn test_reserve_with_preferred_outputs_insufficient() {
    let store = create_test_token_store("mysql_token_reserve_preferred_insufficient").await;
...
async fn test_multi_token_reservation_rolls_back_on_shortfall() {
    let store = create_test_token_store("mysql_token_multi_rolls_back_on_shortfall").await;
...
async fn test_multi_token_reservation_rolls_back_on_first_token() {
    let store = create_test_token_store("mysql_token_multi_rolls_back_on_first_token").await;
...
async fn test_multi_token_reservation_rolls_back_on_unknown_token() {
    let store = create_test_token_store("mysql_token_multi_rolls_back_on_unknown_token").await;
...
async fn test_multi_token_reservation_cancel_restores_every_token() {
    let store = create_test_token_store("mysql_token_multi_cancel_restores_every_token").await;
...
async fn test_multi_token_reservation_finalize_spends_every_token() {
    let store = create_test_token_store("mysql_token_multi_finalize_spends_every_token").await;
...
async fn test_reserve_by_outpoints_rolls_back_on_missing() {
    let store = create_test_token_store("mysql_token_by_outpoints_rolls_back_on_missing").await;
...
async fn test_reserve_by_outpoints_spans_tokens() {
    let store = create_test_token_store("mysql_token_by_outpoints_spans_tokens").await;
