...
async fn test_watched_deposit_addresses() {
    let storage = create_test_storage("watched_deposit_addresses").await;
...
async fn test_instant_claim_status() {
    let storage = create_test_storage("instant_claim_status").await;
...
async fn test_deposit_max_claim_fee() {
    let storage = create_test_storage("deposit_max_claim_fee").await;
...
async fn test_spark_settled_bolt11_joins_at_read() {
    let storage = create_test_storage("settled_bolt11_join").await;
...
async fn test_spark_settled_bolt11_upsert_and_prune() {
    let storage = create_test_storage("spark_settled_bolt11_crud").await;
