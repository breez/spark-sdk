...
async fn test_set_leaves_skips_chains_of_spent_leaves() {
    let store = create_test_tree_store("wtree_test_set_leaves_skips_chains_of_spent_leaves").await;
...
async fn test_store_ancestors_backfills_chain() {
    let store = create_test_tree_store("wtree_store_anc_backfill").await;
...
async fn test_stored_chain_survives_every_refresh() {
    let store = create_test_tree_store("wtree_store_chain_survives").await;
...
async fn test_store_ancestors_does_not_revive_spent_leaf() {
    let store = create_test_tree_store("wtree_store_anc_no_revive").await;
...
async fn test_store_ancestors_for_absent_leaf() {
    let store = create_test_tree_store("wtree_store_anc_absent").await;
...
async fn test_stored_chain_replaces_previous() {
    let store = create_test_tree_store("wtree_test_stored_chain_replaces_previous").await;
...
async fn test_leaves_missing_exit_chains() {
    let store = create_test_tree_store("wtree_test_leaves_missing_exit_chains").await;
    breez_sdk_spark::tree_store_tests::test_leaves_missing_exit_chains(&store).await;
}

#[wasm_bindgen_test]
async fn test_stored_chain_survives_refresh() {
    let store = create_test_tree_store("wtree_test_stored_chain_survives_refresh").await;
...
async fn test_reparented_leaf_needs_its_chain_again() {
    let store = create_test_tree_store("wtree_test_reparented_leaf_needs_its_chain_again").await;
