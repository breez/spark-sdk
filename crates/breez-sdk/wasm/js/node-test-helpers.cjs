...
function createOldV15Database(dbPath) {
  ...
  try {
    ...
    const transaction = db.transaction(() => {
      ...
      // Payment details token table WITHOUT tx_type column (pre-v15)
      db.exec(`
      ...
      // Payment metadata table (with token_conversion_info from migration 14)
      db.exec(`
