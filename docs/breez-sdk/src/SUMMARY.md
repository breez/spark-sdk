...
- [Payment fundamentals](guide/payments.md)
  - [Parsing inputs <span class="badge badge-deprecated">Deprecated</span>](guide/parse.md)
  - [Parsing inputs (Actions) <span class="badge badge-new">New</span>](guide/parse_action.md)
