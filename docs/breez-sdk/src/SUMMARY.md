...
- [Passkey login](guide/passkey.md)
  ...
  - [Credential metadata](guide/passkey_credential_metadata.md)
  - [Managing labels](guide/passkey_labels.md)
  - [PRF providers](guide/passkey_prf_providers.md)
...
- [Advanced features](guide/advanced.md)
  ...
  - [Server deployments](guide/server_deployments.md)
    - [Serving end-user wallets](guide/server_mode.md)
    - [Treasury wallets](guide/treasury.md)
