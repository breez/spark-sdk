...
- [Getting started](guide/getting_started.md)
  ...
  - [Initializing the SDK <span class="badge badge-deprecated">Deprecated</span>](guide/initializing.md)
  - [Connecting to the SDK <span class="badge badge-new">New</span>](guide/connect.md)
