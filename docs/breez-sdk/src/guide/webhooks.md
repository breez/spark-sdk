...
|-----------|----------------|-------------|
| {{#enum WebhookEventType::LightningReceiveFinished}} | `SPARK_LIGHTNING_RECEIVE_FINISHED` | A Lightning receive finished |
| {{#enum WebhookEventType::LightningSendFinished}} | `SPARK_LIGHTNING_SEND_FINISHED` | A Lightning send finished |
| {{#enum WebhookEventType::CoopExitFinished}} | `SPARK_COOP_EXIT_FINISHED` | A cooperative exit finished |
| {{#enum WebhookEventType::StaticDepositFinished}} | `SPARK_STATIC_DEPOSIT_FINISHED` | A static deposit claim finished |
