...
| **PaymentMetadataUpdated** | The provider confirmed the order and the payment now carries its {{#name conversion_info}}. This can arrive after **PaymentSucceeded**, which may report the payment as a plain Spark transfer. | |
