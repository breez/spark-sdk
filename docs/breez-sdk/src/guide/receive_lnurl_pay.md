...
> **Note:** For LUD-21 the LNURL server needs to know whether invoices were paid. This can be disabled by default for privacy reasons. See [LNURL Verify Support](./config.md#lnurl-verify-support).
