<h2 id="issuing-tokens">
    ...
    <a class="tag" target="_blank" href="https://breez.github.io/spark-sdk/breez_sdk_spark/struct.BreezSdk.html#method.get_issuer_sdk">API docs</a>
</h2>

The Breez SDK provides a specialized Issuer SDK for managing custom token issuance on the Spark network using the using the [BTKN protocol](https://docs.spark.money/learn/tokens/hello-btkn). This functionality enables token creators to issue, manage, and control their own tokens with advanced features.

{{#tabs issuing_tokens:get-issuer-sdk}}

<h2 id="token-creation">
    <a class="header" href="#token-creation">Token creation</a>
    <a class="tag" target="_blank" href="https://breez.github.io/spark-sdk/breez_sdk_spark/struct.BreezIssuerSdk.html#method.create_issuer_token">API docs</a>
</h2>
...
<h3 id="minting-a-token">
    ...
    <a class="tag" target="_blank" href="https://breez.github.io/spark-sdk/breez_sdk_spark/struct.BreezIssuerSdk.html#method.mint_issuer_token">API docs</a>
</h3>
...
<h3 id="burning-a-token">
    ...
    <a class="tag" target="_blank" href="https://breez.github.io/spark-sdk/breez_sdk_spark/struct.BreezIssuerSdk.html#method.burn_issuer_token">API docs</a>
</h3>
