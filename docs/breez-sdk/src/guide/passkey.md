...
The next subsection covers the two ways to set up the RP. The subsections after that describe each platform's configuration file in detail; you only need the ones for the platforms you ship on.
