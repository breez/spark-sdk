...
| `isMature` | Whether the deposit has reached the standard claim depth (3 confirmations). Deposits below it can still be credited through an [instant or expedited claim](onchain_claims.md#instant-expedited-claims). |
