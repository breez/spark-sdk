...
1. Collect a non-zero amount before calling `BuyBitcoin`.
2. On mobile, redirect to the returned URL. On desktop, render it as a QR code and dismiss when `SdkEventPaymentSucceeded` fires for the invoice.
