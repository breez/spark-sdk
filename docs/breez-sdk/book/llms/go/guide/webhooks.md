...
|-----------|----------------|-------------|
| `WebhookEventTypeLightningReceiveFinished` | `SPARK_LIGHTNING_RECEIVE_FINISHED` | A Lightning receive finished |
| `WebhookEventTypeLightningSendFinished` | `SPARK_LIGHTNING_SEND_FINISHED` | A Lightning send finished |
| `WebhookEventTypeCoopExitFinished` | `SPARK_COOP_EXIT_FINISHED` | A cooperative exit finished |
| `WebhookEventTypeStaticDepositFinished` | `SPARK_STATIC_DEPOSIT_FINISHED` | A static deposit claim finished |
