...
|-----------|-------------|
| `WebhookEventTypeLightningReceiveFinished` | A Lightning receive operation completed |
| `WebhookEventTypeLightningSendFinished` | A Lightning send operation completed |
| `WebhookEventTypeCoopExitFinished` | A cooperative exit completed |
| `WebhookEventTypeStaticDepositFinished` | A static deposit completed |
