...
8. **Reflect payment progress as it happens**, driven by SDK events: see the [receive payment UX recommendations](/llms/flutter/guide/receive_payment.md#lightning-1).
