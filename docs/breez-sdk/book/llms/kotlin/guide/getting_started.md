...
- **[Installing the SDK](/llms/kotlin/guide/install.md)**
- **[Testing and development](/llms/kotlin/guide/testing.md)**
- **[Initializing the SDK](/llms/kotlin/guide/initializing.md)**
  - **[Customizing the SDK](/llms/kotlin/guide/customizing.md)**
- **[Getting the SDK info](/llms/kotlin/guide/get_info.md)**
- **[Listening to events](/llms/kotlin/guide/events.md)**
- **[Adding logging](/llms/kotlin/guide/logging.md)**
- **[Spark status](/llms/kotlin/guide/spark_status.md)**
...
When implementing the Breez SDK, we recommend reading through our [UX Guidelines](/llms/kotlin/guide/uxguide.md) to provide a consistent and intuitive experience for your end-users.
