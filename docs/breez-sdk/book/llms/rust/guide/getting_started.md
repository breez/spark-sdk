...
- **[Installing the SDK](/llms/rust/guide/install.md)**
- **[Testing and development](/llms/rust/guide/testing.md)**
- **[Initializing the SDK](/llms/rust/guide/initializing.md)**
  - **[Customizing the SDK](/llms/rust/guide/customizing.md)**
- **[Getting the SDK info](/llms/rust/guide/get_info.md)**
- **[Listening to events](/llms/rust/guide/events.md)**
- **[Adding logging](/llms/rust/guide/logging.md)**
- **[Spark status](/llms/rust/guide/spark_status.md)**
...
When implementing the Breez SDK, we recommend reading through our [UX Guidelines](/llms/rust/guide/uxguide.md) to provide a consistent and intuitive experience for your end-users.
