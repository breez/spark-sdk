...
A rejected amount surfaces as `SdkError::CrossChainAmountOutOfRange`, carrying `too_small` for the direction and the published bound in whichever denominations the provider publishes.
