...
- **[Using LNURL-Auth]**
- **[LNURL-Verify]** — Payment verification via [LUD-21](https://github.com/lnurl/luds/blob/luds/21.md) and Nostr Zap receipts via [NIP-57](https://github.com/nostr-protocol/nips/blob/master/57.md).
