...
|-----------|-------------|
| `WebhookEventType.LIGHTNING_RECEIVE_FINISHED` | A Lightning receive operation completed |
| `WebhookEventType.LIGHTNING_SEND_FINISHED` | A Lightning send operation completed |
| `WebhookEventType.COOP_EXIT_FINISHED` | A cooperative exit completed |
| `WebhookEventType.STATIC_DEPOSIT_FINISHED` | A static deposit completed |
