...
|-----------|----------------|-------------|
| `WebhookEventType.LIGHTNING_RECEIVE_FINISHED` | `SPARK_LIGHTNING_RECEIVE_FINISHED` | A Lightning receive finished |
| `WebhookEventType.LIGHTNING_SEND_FINISHED` | `SPARK_LIGHTNING_SEND_FINISHED` | A Lightning send finished |
| `WebhookEventType.COOP_EXIT_FINISHED` | `SPARK_COOP_EXIT_FINISHED` | A cooperative exit finished |
| `WebhookEventType.STATIC_DEPOSIT_FINISHED` | `SPARK_STATIC_DEPOSIT_FINISHED` | A static deposit claim finished |
