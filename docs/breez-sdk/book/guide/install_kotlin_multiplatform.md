...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("technology.breez.spark:breez-sdk-spark-kmp:0.22.0")
        }
    }
}
```
...
```gradle
plugins {
    id("technology.breez.spark.kmp") version "0.22.0"
}
...
``` swift
.package(url: "https://github.com/breez/breez-sdk-spark-swift.git", from: "0.22.0"),
```
