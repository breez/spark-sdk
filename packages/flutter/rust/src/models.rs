...
#[frb(mirror(DeleteWebhookRequest))]
pub struct _DeleteWebhookRequest {
    pub webhook_id: String,
}

#[frb(mirror(DeleteWebhookResponse))]
pub struct _DeleteWebhookResponse {
    pub success: bool,
}
...
#[frb(mirror(ListWebhooksResponse))]
pub struct _ListWebhooksResponse {
